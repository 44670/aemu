...
impl VfpBinaryOp {
    fn eval_f32(self, dst: f32, lhs: f32, rhs: f32) -> f32 {
        match self {
            Self::MulAdd => dst + (lhs * rhs),
            Self::MulSub => dst - (lhs * rhs),
            Self::NegMulSub => -dst + (lhs * rhs),
            Self::NegMulAdd => -dst - (lhs * rhs),
            Self::Mul => lhs * rhs,
            Self::NegMul => -(lhs * rhs),
            Self::Add => lhs + rhs,
            Self::Sub => lhs - rhs,
    ...
    fn eval_f64(self, dst: f64, lhs: f64, rhs: f64) -> f64 {
        match self {
            Self::MulAdd => dst + (lhs * rhs),
            Self::MulSub => dst - (lhs * rhs),
            Self::NegMulSub => -dst + (lhs * rhs),
